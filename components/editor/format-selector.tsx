...
import { Video, Crown, ChevronDown } from "lucide-react";
...
export function FormatSelector({ selectedFormat, onFormatChange, isPro = false, onUpgradeClick }: FormatSelectorProps) {
  ...
  const selectedQuality = qualities.find(q => q.id === selectedFormat);
  ...
  return (
    <div className="space-y-2.5">
      ...
      >
        ...
        <ChevronDown
          className={cn(
            "h-4 w-4 text-[#635F69] transition-transform duration-200",
